...
class ConfigController extends Controller
{
        public function geocode_api(Request $request)
    {
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='."AIzaSyCKkt6EeNUTnPBtyG82U1xhfcuKliiK5s0");
        /*$response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='."AIzaSyDLzIxcBqRdn2R74kXNXNKpaKp9v2phJl0");*/
